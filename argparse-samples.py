...
"""argparse-samples.py at https://github.com/wilsonmar/python-samples/blob/main/argparse-samples.py
STATUS: AttributeError: module 'argparse' has no attribute 'ArgumentParser'
"v002 + docstring desc :argparse-samples.py"

This program shows how to specify command line arguments into this program.
