...
# See https://wilsonmar.github.io/python-samples/#PgmMetadata
...
if process_romans:
    ...
    print_trace(f'process_romans: roman_to_int: {my_roman} => {my_number} ')

    my_roman_num = 2021  # = "MMXXI"
    ob1 = int_to_roman(my_roman_num)
    print_trace(f'process_romans: int_to_roman: {my_number} ==> {my_roman} ')
