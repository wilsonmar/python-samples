...
This is an adaptation of a classic two-player adversarial game 
perhaps played to settle an arugment toward achieving world peace.

The "mm" in the name is for this program's use of the Minimax algorithm, which make this game unbeatable.
Thus, this program helps you experience the dystopian futility of playing with an AI which 
will never lose to a human player.

The minimax function is obtained by importing the math library.
The algorithm works by (recursively) building a game tree to 
evaluate all possible actions to their terminal states,
and backtracks trhough what moves got it there, to choose the best moves.

Thus, Minimax is considered a "brute force" approach practical only in small
contexts such as the maximum 9 possible moves within the 3x3 board.

TODO: This game can be expanded by adding a larger grid, such as 4x4 for a 
maximum of 16 actions. Real life situations would be much more complex.

TODO: The minimax algorithm is explained in video https://www.youtube.com/watch?v=SLgZhpDsrfc
which describes "alpha-beta pruning" optimizations explained by 
   * https://www.youtube.com/watch?v=l-hh51ncgDI Sabastian Lange
   * https://en.wikipedia.org/wiki/Minimax
   * https://www.geeksforgeeks.org/minimax-algorithm-in-game-theory-set-1-introduction/
   * https://www.youtube.com/watch?v=3nzupVMpZeA
   * https://www.youtube.com/watch?v=2Tr8LkyU78c describes MiniMax
   * https://www.youtube.com/watch?v=trKjYdBASyQ Coding Challenge 154

The base code was generated by https://www.perplexity.ai/search/tic-tak-toe-nn_NRtkZTCSxOyC7uIElMQ
which does NOT use Python class objects. Other similar videos:

ABOUT UNIT TESTING:

This file is within a folder so that, during unit testing, this program can be 
...
based on video https://www.youtube.com/watch?v=n2o8ckO-lfk describing
code at https://github.com/garrett-codes/tictactoe/blob/main/tictactoe.py
